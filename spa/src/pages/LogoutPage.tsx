        ...
        {isComplete && (
          <>
            <div className="text-center mb-6">
              <div className={`w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-full`} style={{ background: status.includes('successfully') ? 'rgba(34,195,166,0.15)' : 'rgba(214,69,69,0.15)' }}>
